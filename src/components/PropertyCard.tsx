...
const PropertyCard: React.FC<PropertyCardProps> = ({ property, onClick }) => {
  return (
    <div 
      onClick={onClick}
      className="bg-white rounded-xl shadow-lg overflow-hidden transition-transform hover:scale-[1.02] hover:shadow-xl cursor-pointer"
    >
      ...
      <div className="p-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <button 
            onClick={(e) => {
              e.stopPropagation();
              // Contact functionality handled by parent
            }}
